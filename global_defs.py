...
# top directories
PATH_BASE_FOLDER = r'G:\f\SJTUstudy\G3_SEMESTER2\data_science\project2\workspace\prj3\prj3\Animals_with_Attributes2'.replace('\\','/')
PATH_FEATURES_FOLDER = r'G:\f\SJTUstudy\G3_SEMESTER2\data_science\project2\workspace\prj3\prj3\Features/ResNet101'.replace('\\','/')
PATH_IMAGES_FOLDER = r'G:\f\SJTUstudy\G3_SEMESTER2\data_science\project2\workspace\prj3\prj3\Animals_with_Attributes2/JPEGImages'.replace('\\','/')
